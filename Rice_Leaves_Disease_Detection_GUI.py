...
windo.iconbitmap('D:/Saikat Sheet/Disease Detection in Rice Leaves/images/rice.ico')
windo.resizable(0,0)
...
def prediction():
    ...
    img = load_image(path)
    try:
        with open('D:/Saikat Sheet/Disease Detection in Rice Leaves/model/Rice_Leaves_Disease_Detection.pkl', 'rb') as f:
            clf = pickle.load(f)
...
ri = PIL.Image.open('D:/Saikat Sheet/Disease Detection in Rice Leaves/images/rice.png')
